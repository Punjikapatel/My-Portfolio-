...
downloadButton.addEventListener('click', function() {
    ...
    downloadLink.href = './images/punjika..Resume..pdf';  // Replace with the actual path to your CV file
    downloadLink.download = 'punjika..Resume..pdf';  // Replace with your desired file name
